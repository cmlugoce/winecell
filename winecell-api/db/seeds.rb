...
Wine.create(name: "Juggernaut Hillside", description: "Full body, medium acidity and grippy tannins.  ", wine_type: "Cabernet Sauvignon", year: 2015, price: 20, image:"https://www.warehousewinesandspirits.com/images/sites/warehousewinesandspirits/labels/w1566740fw_1.jpg")
Wine.create(name: "Cotes de Provence", description: "Peach nose and flavor. Nice round body with a bit of creaminess . ", wine_type: "Rose", year: 2017, price: 17, image:"https://www.savortonight.com/wp-content/uploads/2017/03/VieVite%CC%81-rose-wine-%E2%80%93-@fooddrunkie-6974.jpg")
...
Wine.create(name: "Electra Red", description: " Light grapey flavor with a nice nose. Smells like flowers and is smooth. Nice sipping wine. Would pair nicely with a heavy pastry. ", wine_type: "California Moscato", year: 2015, price: 20, image:"https://justintoxicate.files.wordpress.com/2013/10/20131001_172839.jpg")
Wine.create(name: "Belle Glos", description: "Notes of vanilla oak and candle wax on the nose. Color is dark in the glass, really dark for Pinot. The taste is a heavy cherry, blueberries and dark mulberry compote. ", wine_type: "Pinot Noir", year: 2016, price: 40, image:"https://i.ytimg.com/vi/xCZqglSo5tg/hqdefault.jpg")
